...
class GUI {
  static init() {
    const exampleItem = new ListItem(
      "Title",
    ...
    const exampleItem1 = new ListItem(
      "Title1",
      "this is a description",
      "2020-12-14",
      "high",
    ...
    const exampleItem2 = new ListItem(
      "Title2",
      "this is a description",
      "2020-12-14",
      "high",
    ...
    const exampleItem3 = new ListItem(
      "Title3",
      "this is a description",
      "2020-12-14",
      "high",
    ...
    const exampleItem4 = new ListItem(
      "Title4",
      "this is a description",
      "2020-12-14",
      "high",
    ...
    const exampleItem5 = new ListItem(
      "Title5",
      "this is a description",
      "2020-12-14",
      "high",
    ...
    const exampleItem6 = new ListItem(
      "Title6",
      "this is a description",
      "2020-12-14",
      "high",
    ...
    const exampleItem7 = new ListItem(
      "Title7",
      "this is a description",
      "2020-12-14",
      "high",
    ...
    const exampleItem8 = new ListItem(
      "Title8",
      "this is a description",
      "2020-12-14",
      "high",
